...
| Final Loss | 0.1412 (vs 0.6079 in Project 6) |
...
|--------|------|---------|----------------|
| ONNX Float32 | 4.70 KB | 0.0155 ms | 100% |
| ONNX INT8 Quantized | 7.16 KB | 0.0344 ms | 100% |
| TFLite Float32 | 5.52 KB | 0.0021 ms | 100% |
| TFLite INT8 Quantized | 6.03 KB | 0.0032 ms | 100% |
